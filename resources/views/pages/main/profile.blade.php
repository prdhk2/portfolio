...
<main class="page" aria-labelledby="profileTitle">
    <header class="hero">
        <div class="hero-left">
            ...
            <p class="role">Engineer · Web Developer</p>
            ...
            <div class="actions">
                <a class="btn primary" href="#" id="contactBtn">Contact</a>
    ...
    <section class="overview">
        <h2>What I do</h2>
        <p><span style="margin-left: 1rem">Design</span> and implement scalable web apps, APIs, and tooling. I enjoy working across the stack and improving developer workflows.</p>
        ...
        <div id="contactModal" class="contact-modal" hidden aria-labelledby="contactModalTitle" aria-hidden="true">
            <div class="contact-modal__backdrop"></div>
            <div class="contact-modal__content" role="dialog">
                <div class="contact-modal__header">
                    <h3 id="contactModalTitle">Get in Touch</h3>
                    <button class="contact-modal__close" aria-label="Close contact modal">&times;</button>
                </div>
                
                <div class="contact-modal__body">
                    <p class="contact-modal__subtitle">Choose your preferred platform to connect</p>
                    
                    <div class="contact-platforms">
                        <a href="https://facebook.com/prdhk.sty" class="platform-card" target="_blank" rel="noopener">
                            ...
                            <div class="platform-info">
                                ...
                                <span class="platform-desc">Connect socially</span>
                            </div>
                        </a>
                        
                        <a href="https://instagram.com/prdhk_" class="platform-card" target="_blank" rel="noopener">
                            <div class="platform-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <div class="platform-info">
                                ...
                                <span class="platform-desc">Follow updates</span>
                            </div>
                        </a>
                        
                        <a href="https://wa.me/6285888203401" class="platform-card" target="_blank" rel="noopener">
                            <div class="platform-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <div class="platform-info">
                                ...
                                <span class="platform-desc">Instant message</span>
                            </div>
                        </a>
                        
                        <a href="mailto:pradhika2112@gmail.com" class="platform-card">
                            <div class="platform-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <div class="platform-info">
                                ...
                                <span class="platform-desc">Send directly</span>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <!-- Projects panel (hidden until a skill is clicked) -->
